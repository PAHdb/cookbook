...
htmlhelp_basename = 'PAHdbcookbook'
...
latex_documents = [
    (master_doc, 'PAHdbcookbook.tex', 'PAHdb cookbook',
...
man_pages = [
    (master_doc, 'pahdbcookbook', 'PAHdb cookbook',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PAHdbcookbook', 'PAHdb cookbook',
     author, 'PAHdbcookbook', 'One line description of project.',
     'Miscellaneous'),
]
